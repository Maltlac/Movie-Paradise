                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <form class="form-horizontal needs-validation" method="GET" action="/gererSeries">  
                                <div class="">
                                    <div class="pull-left">
                ...
                <div class="panel-body table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                        <a href="javascript:void(0)" id="edit-serie" data-url="{{ route('serie.show', $data->id) }}" class="btn btn-primary d-inline "><i class="fa fa-pencil-alt"></i></a>
                                        <a href="javascript:void(0)" id="delete-serie" data-url="{{ route('serie.show', $data->id) }}" class="btn btn-danger d-inline " ><i class="fa fa-times"></i></a>

                                </td>
                                <td>{{ $data->id }}</td>
                                <td>{{ $data->titre }}</td>
                                <td>{{ $data->dateSortie }}</td>
                                <td><a href="/gererSeries/saison/{{$data->id}} " class="btn btn-sm btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></i></a> </td>
                                <td><a href="serie/{{$data->id}} " class="btn btn-sm btn-success"><i class="fa fa-search"></i></a></td>
                            </tr>
                            @endforeach
                ...
                <div class="panel-footer">
                    <div class="row">
                            ...
                            <ul class="pagination hidden-xs pull-right">
                                {!! $series->appends(Request::except('page'))->render() !!}
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="serieUpdateForm" name="serieUpdateForm" class="form-horizontal " action="panneauCtrl/update/serie" method="POST">
                @csrf 
...
setTimeout(function() { $("#hideDiv").fadeOut(1500); }, 5000)
    ...
    document.getElementById('pagination').onchange = function() { 
        window.location = "{!! $series->url(1) !!}&items=" + this.value; 
    }; 
    ...
    $(document).ready(function () {
       ...
       $('body').on('click', '#delete-serie', function () {
          ...
          $.get(serieURL, function (data) {
            ...
            $('#deleteserieConfirme').attr('href',"/panneauCtrl/delete/serie/"+data.id);
